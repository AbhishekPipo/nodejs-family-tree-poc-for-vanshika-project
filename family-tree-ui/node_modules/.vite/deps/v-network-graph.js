...
// node_modules/v-network-graph/lib/index.mjs
...
var ce = Math.pow;
var Kn = (e, t, n) => t in e ? dr(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n;
var se = (e, t) => {
  for (var n in t || (t = {}))
...
var Fo = Symbol("containers");
function Er(e) {
  provide(Fo, e);
}
function En() {
  const e = q(inject(Fo), "containers");
  return {
...
function Mr(e) {
  ...
  if (n < 0)
    return false;
  var o = t.length - 1;
  return n == o ? t.pop() : kr.call(t, n, 1), --this.size, true;
}
function Tr(e) {
  var t = this.__data__, n = Bt(t, e);
...
var Nr = Uo || Lr || Function("return this")();
var xe = Nr;
var Dr = xe.Symbol;
var De = Dr;
var Go = Object.prototype;
var Zr = Go.hasOwnProperty;
var jr = Go.toString;
var lt = De ? De.toStringTag : void 0;
function Br(e) {
...
var Wr = "[object Null]";
var Fr = "[object Undefined]";
var Qn = De ? De.toStringTag : void 0;
function Xe(e) {
...
var Ur = "[object AsyncFunction]";
var Gr = "[object Function]";
var Xr = "[object GeneratorFunction]";
var qr = "[object Proxy]";
function Pn(e) {
  if (!ke(e))
    return false;
...
var es = /[\\^$.*+?()[\]{}|]/g;
var ts = /^\[object .+?Constructor\]$/;
var ns = Function.prototype;
var os = Object.prototype;
var is = ns.toString;
var rs = os.hasOwnProperty;
var ss = RegExp(
...
var eo = Xo && typeof module == "object" && module && !module.nodeType && module;
var As = eo && eo.exports === Xo;
var to = As ? xe.Buffer : void 0;
var no = to ? to.allocUnsafe : void 0;
function Ls(e, t) {
  if (t)
    return e.slice();
...
var Us = Yo.hasOwnProperty;
var Gs = Yo.propertyIsEnumerable;
var Xs = io(function() {
  return arguments;
}()) ? io : function(e) {
...
var ro = Jo && typeof module == "object" && module && !module.nodeType && module;
var Js = ro && ro.exports === Jo;
var so = Js ? xe.Buffer : void 0;
var ea = so ? so.isBuffer : void 0;
var ta = ea || Qs;
var At = ta;
...
var ei = oa.toString;
var ra = ia.hasOwnProperty;
var sa = ei.call(Object);
function ti(e) {
  if (!Ze(e) || Xe(e) != na)
    return false;
  var t = Ko(e);
...
var ha = "[object Map]";
var va = "[object Number]";
var pa = "[object Object]";
var ga = "[object RegExp]";
var ma = "[object Set]";
var ba = "[object String]";
var ya = "[object WeakMap]";
var wa = "[object ArrayBuffer]";
var xa = "[object DataView]";
var Ea = "[object Float32Array]";
var Pa = "[object Float64Array]";
var Sa = "[object Int8Array]";
var ka = "[object Int16Array]";
var Ma = "[object Int32Array]";
var Ta = "[object Uint8Array]";
var Oa = "[object Uint8ClampedArray]";
var Ca = "[object Uint16Array]";
var $a = "[object Uint32Array]";
var Q = {};
Q[Ea] = Q[Pa] = Q[Sa] = Q[ka] = Q[Ma] = Q[Ta] = Q[Oa] = Q[Ca] = Q[$a] = true;
Q[aa] = Q[la] = Q[wa] = Q[ca] = Q[xa] = Q[ua] = Q[da] = Q[fa] = Q[ha] = Q[va] = Q[pa] = Q[ga] = Q[ma] = Q[ba] = Q[ya] = false;
function _a(e) {
...
var ni = typeof exports == "object" && exports && !exports.nodeType && exports;
var dt = ni && typeof module == "object" && module && !module.nodeType && module;
var Ia = dt && dt.exports === ni;
var tn = Ia && Uo.process;
var Aa = function() {
  try {
...
function Ka(e, t, n, o, i, r, s) {
  ...
  if (f) {
    ...
    c = l, d || v || x ? Ge(a) ? c = a : Ys(a) ? c = js(a) : v ? (f = false, c = Ls(l, true)) : x ? (f = false, c = Zs(l, true)) : c = [] : ti(l) || dn(l) ? (c = a, dn(a) ? c = qa(a) : (!ke(a) || Pn(a)) && (c = Ws(l))) : f = false;
  }
...
function ai(e, t, n) {
  if (!ke(n))
    return false;
  var o = typeof t;
  return (o == "number" ? Ht(n) && oi(t, n.length) : o == "string" && t in n) ? wt(n[t], e) : false;
}
function li(e) {
...
var Sl = 1 / 0;
var ho = De ? De.prototype : void 0;
var vo = ho ? ho.toString : void 0;
function fi(e) {
  if (typeof e == "string")
    return e;
  if (Ge(e))
...
var hi = class {
  activate(t) {
    ...
    const c = watch(() => Object.keys(o.value), u);
...
function _l(e) {
  const t = reactive(vi()), n = Object.keys(t);
  for (const o of n)
    watch(() => e.value[o], () => {
      dl(t[o], e.value[o] || {}, $l);
    }, { immediate: true, deep: true });
  return provide(pi, t), t;
}
function Wt(e) {
  return q(inject(pi), `Configs(${e})`)[e];
}
function zl() {
  return Wt("view");
}
...
function bi(e, t, n, o, i, r) {
  ...
  if (u && c)
    return u == t && c == e;
  var f = -1, d = true, v = n & Bl ? new gt() : void 0;
...
var Hl = 1;
var Vl = 2;
var Wl = "[object Boolean]";
var Fl = "[object Date]";
var Ul = "[object Error]";
var Gl = "[object Map]";
var Xl = "[object Number]";
var ql = "[object RegExp]";
var Kl = "[object Set]";
var Yl = "[object String]";
var Ql = "[object Symbol]";
var Jl = "[object ArrayBuffer]";
var ec = "[object DataView]";
var yo = De ? De.prototype : void 0;
var on = yo ? yo.valueOf : void 0;
...
var ac = sc.propertyIsEnumerable;
var wo = Object.getOwnPropertySymbols;
var lc = wo ? function(e) {
...
function yc(e, t, n, o, i, r) {
  ...
  if (P && !E) {
    ...
    b != h && "constructor" in e && "constructor" in t && !(typeof b == "function" && b instanceof b && typeof h == "function" && h instanceof h) && (P = false);
  }
...
var pn = Pc;
var Eo = "[object Map]";
var Sc = "[object Object]";
var Po = "[object Promise]";
var So = "[object Set]";
var ko = "[object WeakMap]";
...
function zc(e, t, n, o, i, r) {
  ...
  return d ? (r || (r = new Oe()), yc(e, t, n, o, i, r)) : false;
}
function yi(e, t, n, o, i) {
  return e === t ? true : e == null || t == null || !Ze(e) && !Ze(t) ? e !== e && t !== t : zc(e, t, n, o, yi, i);
}
function We(e, t) {
  return yi(e, t);
}
  ...
  return watchEffect(() => {
    ...
    for (const [r, { edges: s, groupWidth: a }] of Object.entries(o.edgeGroups)) {
      ...
      if (a == 0)
        ...
        n.edge.summarize ? l = _o(e.value, s, n, a) : l = false;
      o.edgeGroups[r].summarize = l, l && Object.keys(s).forEach((u) => i[u] = true);
    }
...
function Lc(e, t, n) {
  ...
  for (const [a, l] of Object.entries(r)) {
    ...
    if (u === 1)
      o[f] = { edge: d, pointInGroup: 0, groupWidth: 0 }, i[a] = { edges: l, groupWidth: 0, summarize: false };
    else {
      let v = 0;
      ...
      }), i[a] = { edges: l, groupWidth: E, summarize: false };
    }
  }
...
var R = class _R {
  static fromArray(t) {
    return new _R(t[0] || 0, t[1] || 0);
  }
  static fromObject(t) {
    return new _R(t.x, t.y);
  }
  constructor(t, n) {
    this.x = t, this.y = n;
  }
...
function rn(e, t, n, o, i, r, s) {
  ...
  watch(
    ...
    (u, c) => {
      ...
      f.forEach((v) => {
        const x = a[v];
        x && !x.selected && (x.selected = true);
      }), d.forEach((v) => {
        const x = a[v];
        x && x.selected && (x.selected = false);
      });
    },
    { immediate: true }
    ...
    (u, c) => {
      ...
      f.forEach((v) => {
        const x = a[v];
        x && !x.hovered && (x.hovered = true);
      }), d.forEach((v) => {
        const x = a[v];
        x && x.hovered && (x.hovered = false);
      });
    }
  );
  const l = computed(() => {
...
function Uc(e, t, n, o, i, r) {
  const s = {
    ...
    selected: o,
    hovered: false,
    selectable: computed(() => e.value[n] ? z.value(i.selectable, e.value[n]) : unref(s.selectable)),
    zIndex: computed(() => e.value[n] ? z.value(i.zOrder.zIndex, e.value[n]) : unref(s.zIndex))
  };
  t[n] = s, r(
    e,
    n,
...
function eu(e, t, n, o, i, r, s) {
  ...
  ), f = Al(), d = Ic(e.objects, t.objects, o), v = ref([]), {
    states: x,
    zOrderedList: P
    //
  } = rn(
  ...
  const {
    ...
    (w, b, h) => {
      const g = h;
      g.clickable = computed(() => w.value[b] ? z.value(o.path.clickable, w.value[b]) : false), g.hoverable = computed(() => w.value[b] ? z.value(o.path.hoverable, w.value[b]) : false), g.path = w.value[b], g.edges = computed(() => w.value[b].edges.map((T) => ({ edgeId: T, edge: t.objects.value[T] })).filter((T) => T.edge));
    }
  ), m = {
    nodeStates: u,
    edgeStates: x,
  ...
  return provide(Oi, m), m;
}
function tu(e) {
  return e.summarized;
}
function Me() {
  return q(inject(Oi), "states");
}
function nu(e, t, n, o) {
...
function ou(e, t, n, o, i, r) {
  n.shape = computed(() => e.value[t] ? nu(e.value[t], n.selected, n.hovered, o) : unref(n.shape)), n.staticShape = computed(() => e.value[t] ? Ci(e.value[t], n.selected, o) : unref(n.staticShape)), n.label = computed(() => e.value[t] ? z.values(o.label, e.value[t]) : unref(n.label)), n.labelText = computed(() => {
    var s, a;
    return o.label.text instanceof Function ? unref(n.label).text : e.value[t] ? (a = (s = e.value[t]) == null ? void 0 : s[unref(n.label).text]) != null ? a : "" : unref(n.labelText);
  }), n.draggable = computed(() => e.value[t] ? z.value(o.draggable, e.value[t]) : unref(n.draggable)), n.oppositeNodeIds = toRef(i, t), n.oppositeNodes = computed(() => Object.entries(n.oppositeNodeIds).reduce((s, a) => {
...
function ru(e, t, n, o, i, r, s, a, l, u) {
  ...
  const v = toRef(
    s.edgeLayoutPoints,
    t
  ), x = toRef(s.summarizedEdges, t), P = watchEffect(() => {
    var j, F, ye, ie, Pe;
    const p = e.value[t];
    if (!p)
      return;
...
function fu(e, t, n, o, i, r, s) {
  ...
  function f(b, h) {
    ...
    const g = (T = (k = e[b]) == null ? void 0 : k.selectable) != null ? T : false;
    if (g) {
...
function vu(e, t, n, o) {
  ...
  function s(v) {
    i.moveCounter = 0, i.pointerCounter === 0 && ve(r).forEach(([x, P]) => {
      document.addEventListener(x, P, { passive: true });
    }), i.pointerCounter++;
  }
  function a(v) {
    i.moveCounter++;
  ...
  onMounted(() => {
    const v = e.value;
    v && (v.addEventListener("pointerdown", s, { passive: true }), v.addEventListener("click", u, { passive: false }), v.addEventListener("dblclick", c, { passive: false }), v.addEventListener("contextmenu", f, { passive: false }), n.value && v.addEventListener("wheel", d, { passive: false }));
  }), onUnmounted(() => {
    const v = e.value;
    ...
    const P = e.value;
    !P || v === x || (v ? P.addEventListener("wheel", d, { passive: false }) : P.removeEventListener("wheel", d));
  });
}
function pu(e, t, n, o, i, r) {
  ...
  function x(p, m) {
    ...
    const w = (g = (h = e[p]) == null ? void 0 : h.selectable) != null ? g : false;
    if (w) {
...
var Ou = Math.min;
function Cu(e, t, n) {
  var o, i, r, s, a, l, u = 0, c = false, f = false, d = true;
...
var _u = 1 / 0;
var zu = nt && 1 / On(new nt([, -0]))[1] == _u ? function(e) {
  return new nt(e);
} : gu;
var Iu = zu;
var Au = 200;
function Lu(e, t, n) {
  var o = -1, i = xu, r = e.length, s = true, a = [], l = a;
  if (n)
    s = false, i = $u;
  else if (r >= Au) {
    var u = t ? null : Iu(e);
...
function zi(e, t, n) {
  var u;
  const o = e.cloneNode(true), i = t.getBBox(), r = 1 / n, s = {
...
function Hu(e, t, n, o, i, r, s, a) {
  ...
  if (a === "append")
    r.forEach((d) => {
      ...
      var x, P;
      const v = (P = (x = i[d]) == null ? void 0 : x.selectable) != null ? P : false;
      (v === true || typeof v == "number" && r.size < v) && r.add(d);
    });
  else {
    const d = new Set(s);
    d.forEach((v) => {
      ...
      var x, P;
      if (!s.has(v)) {
        const E = (P = (x = i[v]) == null ? void 0 : x.selectable) != null ? P : false;
        (E === true || typeof E == "number" && d.size < E) && d.add(v);
      }
...
var Ii = Symbol("mouseEventHandlers");
function Fu(e, t, n, o, i, r, s, a, l, u, c, f, d, v, x, P) {
  const E = {
    selectionMode: ref("container"),
    viewMode: ref("default")
  };
  s.size > 0 ? E.selectionMode.value = "node" : a.size > 0 ? E.selectionMode.value = "edge" : l.size > 0 && (E.selectionMode.value = "path"), watch(E.viewMode, (m) => {
    P.emit("view:mode", m);
  }), vu(e, E, v, P);
  const p = se(se(se(se({
    selectedNodes: s,
  ...
  return provide(Ii, p), p;
}
function Pt() {
  return q(inject(Ii), "mouseEventHandlers");
}
function Uu(e) {
...
var Ai = Symbol("emitter");
function Gu() {
  const e = Uu();
  return provide(Ai, e), e;
}
function Xu() {
  return q(inject(Ai), "event emitter");
}
...
var Gt = {
  ...
  throttle: function(e, t, n) {
    ...
    n || (n = {});
    var u = function() {
      l = n.leading === false ? 0 : o.now(), a = null, s = e.apply(i, r), a || (i = r = null);
    };
    return function() {
      var c = o.now();
      !l && n.leading === false && (l = c);
      var f = t - (c - l);
      return i = this, r = arguments, f <= 0 || f > t ? (clearTimeout(a), a = null, l = c, s = e.apply(i, r), a || (i = r = null)) : !a && n.trailing !== false && (a = setTimeout(u, f)), s;
    };
  },
  /**
...
var qu = Gt;
var Ku = function() {
  var e = "", t, n, o, i = [], r = { passive: true }, s = { passive: false };
...
oe.prototype.setCTM = function(e) {
  ...
  if (t || n) {
    if (t && (this.options.beforeZoom(
      ...
      o === false ? (e.e = this.getPan().x, e.f = this.getPan().y, i = r = true) : Ne.isObject(o) && (o.x === false ? (e.e = this.getPan().x, i = true) : Ne.isNumber(o.x) && (e.e = o.x), o.y === false ? (e.f = this.getPan().y, r = true) : Ne.isNumber(o.y) && (e.f = o.y)), i && r || !this.isPanDifferent(e) ? n = false : (this.updateCache(e), this.options.onPan(this.getPan()));
    }
...
oe.prototype.updateCTM = function() {
  var e = this.getCTM();
  Qu.setCTM(this.viewport, e, this.defs), this.pendingUpdate = false, this.options.onUpdatedCTM && this.options.onUpdatedCTM(e);
};
var Ju = function(e, t) {
  return new oe(e, t);
};
...
U.prototype.handleMouseDown = function(e, t) {
  this.options.preventMouseEventsDefault && (e.preventDefault ? e.preventDefault() : e.returnValue = false), he.mouseAndTouchNormalize(e, this.svg), this.options.dblClickZoomEnabled && he.isDblClick(e, t) ? this.handleDblClick(e) : (this.state = "pan", this.firstEventCTM = this.viewport.getCTM(), this.stateOrigin = ae.getEventPoint(e, this.svg).matrixTransform(
...
U.prototype.getPublicInstance = function() {
  ...
  return this.publicInstance || (this.publicInstance = this.pi = {
    ...
    enableControlIcons: function() {
      return e.options.controlIconsEnabled || (e.options.controlIconsEnabled = true, wn.enable(e)), e.pi;
    },
    disableControlIcons: function() {
      return e.options.controlIconsEnabled && (e.options.controlIconsEnabled = false, wn.disable(e)), e.pi;
    },
...
function ud() {
  ...
  function n(o, i = 300, r = "linear") {
    e && (clearTimeout(e), e = null), t.value = {
      ...
      duration: i,
      timingFunction: r
    }, nextTick(() => Re(this, null, function* () {
      const s = o();
...
function fd(e, t, n, o) {
  if (o) {
    const r = ref(o(e[t])), s = (a) => {
      We(a, r.value) || (r.value = a), We(a, e[t]) || n(`update:${t}`, a);
    };
    return watch(() => o(r.value), s), watch(() => e[t], (a) => s(o(a))), r.value !== e[t] && n(`update:${t}`, r.value), r;
  }
  const i = ref(e[t]);
  return watch(
    () => e[t],
...
function vd() {
  return q(inject(Bi), "Selections");
}
var Ri = Symbol("layouts");
function pd(e) {
  provide(Ri, e);
}
function Rn() {
  return q(inject(Ri), "Layouts");
}
function gd(e, t) {
...
function bd(e, t) {
  ...
  return computed(() => {
    ...
    return gd(o, (r, s) => {
      ut(i, s), md(i, r, s);
    }), "edge-label" in t || "edges-label" in t || ut(i, "edge-labels"), e.node.focusring.visible || ut(i, "focusring"), e.node.label.visible === false && ut(i, "node-labels"), e.path.visible || ut(i, "paths"), i;
  });
}
var yd = ["x", "y", "width", "height", "fill", "stroke", "stroke-width", "stroke-dasharray"];
...
var Pd = ["points", "stroke-width", "stroke"];
var Sd = defineComponent({
  ...
  setup(e) {
    ...
    return (i, r) => (openBlock(), createElementBlock("polyline", {
      points: unref(o),
      fill: "none",
...
var Td = ["id", "markerWidth", "markerHeight", "refX", "refY", "markerUnits"];
var Od = defineComponent({
  ...
  setup(e) {
    ...
    return (s, a) => e.marker.type !== "none" && e.marker.type !== "custom" ? (openBlock(), createElementBlock("marker", {
      key: 0,
      id: e.id,
      markerWidth: unref(o),
...
var Ad = defineComponent({
  ...
  setup(e) {
    const { container: t, svgPanZoom: n } = En(), { zoomLevel: o } = be(), i = Xu(), r = zl(), s = ref({ x: 0, y: 0 }), a = ref({ width: 500, height: 500 });
    onMounted(() => {
      var x;
    ...
    }), (d, v) => (openBlock(), createElementBlock("g", Cd, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(f.value, ([x, P, E, p, m]) => (openBlock(), createElementBlock("path", mergeProps({
        key: `nv${x}`,
        d: `M ${E} ${P} L ${p} ${P}`
      }, m, { style: { "vector-effect": "non-scaling-stroke" } }), null, 16, $d))), 128)),
      (openBlock(true), createElementBlock(Fragment, null, renderList(c.value, ([x, P, E, p, m]) => (openBlock(), createElementBlock("path", mergeProps({
        key: `nh${x}`,
        d: `M ${P} ${E} L ${P} ${p}`
      }, m, { style: { "vector-effect": "non-scaling-stroke" } }), null, 16, _d))), 128)),
      (openBlock(true), createElementBlock(Fragment, null, renderList(u.value, ([x, P, E, p, m]) => (openBlock(), createElementBlock("path", mergeProps({
        key: `tv${x}`,
        d: `M ${E} ${P} L ${p} ${P}`
      }, m, { style: { "vector-effect": "non-scaling-stroke" } }), null, 16, zd))), 128)),
      (openBlock(true), createElementBlock(Fragment, null, renderList(l.value, ([x, P, E, p, m]) => (openBlock(), createElementBlock("path", mergeProps({
        key: `th${x}`,
        d: `M ${P} ${E} L ${P} ${p}`
...
var Ld = defineComponent({
  ...
  setup(e) {
    const { viewport: t } = En(), n = ref(), o = (r, s, a) => {
      r.forEach((l) => {
        var u;
    ...
    return onMounted(() => {
      ...
      i.disconnect();
    }), (r, s) => (openBlock(), createElementBlock("g", {
      ref_key: "background",
      ref: n,
...
var Dd = defineComponent({
  ...
  setup(e) {
    ...
    }), f = computed(() => (t.state.line.stroke.width + 10) * n.value);
    return (d, v) => (openBlock(), createElementBlock("path", {
      class: normalizeClass({ "v-ng-line-background": true, selectable: e.state.selectable }),
      d: unref(c),
      stroke: "transparent",
      "stroke-width": unref(f),
      fill: "none",
      onPointerdown: v[0] || (v[0] = withModifiers((x) => unref(i)(e.id, x), ["stop"])),
      onPointerenterPassive: v[1] || (v[1] = (x) => unref(r)(e.id, x)),
      onPointerleavePassive: v[2] || (v[2] = (x) => unref(s)(e.id, x)),
      onClick: v[3] || (v[3] = withModifiers((x) => unref(a)(e.id, x), ["stop"])),
      onDblclick: v[4] || (v[4] = withModifiers((x) => unref(l)(e.id, x), ["stop"])),
      onContextmenu: v[5] || (v[5] = (x) => unref(u)(e.id, x))
    }, null, 42, Nd));
  }
});
var Zd = defineComponent({
  ...
  setup(e) {
    ...
    return (i, r) => (openBlock(true), createElementBlock(Fragment, null, renderList(unref(n).edgeGroups, ({ summarize: s, edges: a }) => (openBlock(), createElementBlock(Fragment, null, [
      s ? createCommentVNode("", true) : (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(a, (l, u) => (openBlock(), createBlock(Dd, {
        key: u,
        id: u,
        state: unref(t)[u],
...
var jd = ["d", "stroke", "stroke-width", "stroke-dasharray", "stroke-linecap"];
var Hi = defineComponent({
  ...
  setup(e) {
    const t = e, { scale: n } = be(), o = computed(() => t.config.width * n.value), i = computed(() => xt(t.config.dasharray, n.value)), r = computed(() => {
      const s = t.config.animate ? Vt(t.config.dasharray) * t.config.animationSpeed * n.value : false;
      return s ? `--animation-speed:${s}` : void 0;
    });
    return (s, a) => (openBlock(), createElementBlock("path", {
...
var Bd = ["d", "stroke", "stroke-width", "stroke-dasharray", "stroke-linecap"];
var Rd = defineComponent({
  ...
  setup(e) {
    const t = e, { scale: n } = be(), o = computed(() => t.config.width * n.value), i = computed(() => xt(t.config.dasharray, n.value)), r = computed(() => {
      const a = t.config.animate ? Vt(t.config.dasharray) * t.config.animationSpeed * n.value : false;
...
var Hd = ["d", "stroke", "stroke-width", "stroke-dasharray", "stroke-linecap", "marker-start", "marker-end"];
var Vd = defineComponent({
  ...
  setup(e) {
    ...
    }), i = computed(() => t.config.width * n.value), r = computed(() => xt(t.config.dasharray, n.value)), s = computed(() => {
      const a = t.config.animate ? Vt(t.config.dasharray) * t.config.animationSpeed * n.value : false;
      return a ? `--animation-speed:${a}` : void 0;
    });
    return (a, l) => (openBlock(), createElementBlock("path", {
...
var Wd = defineComponent({
  ...
  setup(e) {
    const t = Et();
    return (n, o) => e.state.loop ? (openBlock(), createBlock(Rd, mergeProps({ key: 0 }, e.state.position, {
    ...
    }), null, 16, ["radius", "is-large-arc", "is-clockwise", "class", "config", "marker-start", "marker-end"])) : unref(t).type == "straight" || !e.state.curve ? (openBlock(), createBlock(Hi, mergeProps({
      key: 1,
      "data-edge-id": e.id
    }, e.state.position, {
      class: [{ selectable: e.state.selectable, hover: e.state.hovered, selected: e.state.selected }, "v-ng-edge"],
      ...
      "marker-start": e.state.sourceMarkerId ? `url('#${e.state.sourceMarkerId}')` : void 0,
      "marker-end": e.state.targetMarkerId ? `url('#${e.state.targetMarkerId}')` : void 0
    }), null, 16, ["data-edge-id", "class", "config", "marker-start", "marker-end"])) : (openBlock(), createBlock(Vd, {
      key: 2,
      "data-edge-id": e.id,
...
var Fd = ["cx", "cy", "r", "fill", "stroke", "stroke-width", "stroke-dasharray"];
var Ud = ["x", "y", "width", "height", "rx", "ry", "fill", "stroke", "stroke-width", "stroke-dasharray"];
var Xt = defineComponent({
  ...
  setup(e) {
    const t = e, { scale: n } = be(), o = ref(t.baseX), i = ref(t.baseY), r = ref(0), s = ref("#000000"), a = ref(void 0), l = ref(0), u = ref(0), c = ref(0), f = ref(0);
    return watchEffect(() => {
      var v;
      const d = n.value;
    ...
    }), (d, v) => e.config.type === "circle" ? (openBlock(), createElementBlock("circle", {
      key: 0,
    ...
    }, null, 8, Fd)) : (openBlock(), createElementBlock("rect", {
      key: 1,
...
var Gd = ["rx", "ry", "fill", "transform"];
var Xd = ["x", "y", "dominant-baseline", "font-family", "font-size", "fill"];
var qd = ["x", "dy", "dominant-baseline"];
var qt = defineComponent({
  ...
  setup(e) {
    ...
    }), s = computed(() => r.value * t.config.lineHeight), a = computed(() => {
      const E = t.dominantBaseline;
      return E === "hanging" ? 0 : E === "central" ? -(s.value * (i.value.length - 1)) / 2 : -s.value * (i.value.length - 1);
    }), l = ref(), u = ref(""), c = reactive({ x: 0, y: 0, width: 0, height: 0 }), f = computed(() => {
      var b, h;
    ...
    return (E, p) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        e.config.background && e.config.background.visible ? (openBlock(), createElementBlock("rect", mergeProps({
          ...
          rx: ((w = (m = e.config.background) == null ? void 0 : m.borderRadius) != null ? w : 0) * unref(o),
          ry: ((h = (b = e.config.background) == null ? void 0 : b.borderRadius) != null ? h : 0) * unref(o),
          fill: (k = (g = e.config.background) == null ? void 0 : g.color) != null ? k : "#ffffff",
          transform: u.value
        }), null, 16, Gd)) : createCommentVNode("", true),
        createBaseVNode("text", mergeProps({
          ...
          ], 64)) : (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(unref(i), (T, _) => (openBlock(), createElementBlock("tspan", {
            key: _,
            x: e.x,
            dy: _ == 0 ? unref(a) : unref(s),
            "dominant-baseline": e.dominantBaseline
          }, toDisplayString(T), 9, qd))), 128))
        ], 16, Xd)
      ], 64);
    };
  }
...
var Kd = defineComponent({
  ...
  setup(e) {
    ...
    } = Pt(), { edgeStates: u } = Me(), c = ref({ p1: { x: 0, y: 0 }, p2: { x: 0, y: 0 } }), f = ref({ x: 0, y: 0 });
    watchEffect(() => {
    ...
    const d = computed(() => Object.keys(t.edges)), v = computed(() => z.values(n.summarized.label, t.edges)), x = computed(() => z.values(n.summarized.shape, t.edges)), P = computed(() => z.values(n.summarized.stroke, t.edges)), E = computed(() => d.value.some((w) => u[w].hovered)), p = computed(() => d.value.some((w) => u[w].selectable)), m = computed(() => d.value.some((w) => u[w].selected));
    return (w, b) => (openBlock(), createElementBlock("g", {
      class: normalizeClass({ "v-ng-line-summarized": true, hovered: unref(E), selectable: unref(p), selected: unref(m) }),
      onPointerdown: b[0] || (b[0] = withModifiers((h) => unref(o)(unref(d), h), ["stop"])),
      onPointerenterPassive: b[1] || (b[1] = (h) => unref(i)(unref(d), h)),
      onPointerleavePassive: b[2] || (b[2] = (h) => unref(r)(unref(d), h)),
      onClick: b[3] || (b[3] = withModifiers((h) => unref(s)(unref(d), h), ["stop"])),
      onDblclick: b[4] || (b[4] = withModifiers((h) => unref(a)(unref(d), h), ["stop"])),
      onContextmenu: b[5] || (b[5] = (h) => unref(l)(unref(d), h))
    }, [
      createVNode(Hi, mergeProps(c.value, {
        config: unref(P),
        "data-edge-id": unref(d)[0]
...
var Yd = { class: "v-ng-edge-overlay" };
var Do = defineComponent({
  ...
  setup(e) {
    ...
    return (c, f) => (openBlock(), createElementBlock("g", Yd, [
...
var Qd = defineComponent({
  ...
  setup(e) {
    ...
    return (i, r) => (openBlock(true), createElementBlock(Fragment, null, renderList(unref(n), (s) => (openBlock(), createElementBlock(Fragment, null, [
      unref(tu)(s) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        (openBlock(), createBlock(Kd, {
          key: s.key,
          edges: s.group.edges,
          layouts: unref(o).nodes
        }, null, 8, ["edges", "layouts"])),
        e.hasEdgeOverlaySlot ? (openBlock(), createBlock(Do, {
          key: s.key,
          edges: s.group.edges,
          state: unref(t)[Object.keys(s.group.edges)[0]],
          "is-summarized": true
        }, {
          default: withCtx((a) => [
        ...
        (openBlock(), createBlock(Wd, {
          id: s.key,
          key: s.key,
          state: unref(t)[s.key],
          "source-pos": unref(o).nodes[s.edge.source],
          "target-pos": unref(o).nodes[s.edge.target]
...
var Jd = { class: "v-ng-layer-edges" };
var ef = defineComponent({
  __name: "VEdgesLayer",
  setup(e) {
    const t = useSlots(), n = computed(() => "edge-overlay" in t);
    return (o, i) => (openBlock(), createElementBlock("g", Jd, [
      createVNode(Zd),
      createVNode(Qd, { "has-edge-overlay-slot": unref(n) }, createSlots({ _: 2 }, [
        unref(n) ? {
          name: "default",
          fn: withCtx((r) => [
            renderSlot(o.$slots, "edge-overlay", normalizeProps(guardReactiveProps(r)))
          ]),
          key: "0"
        } : void 0
...
var tf = defineComponent({
  ...
  setup(e) {
    const t = e, { scale: n } = be(), o = computed(() => Ti(
    ...
    return (i, r) => e.state.loop ? createCommentVNode("", true) : renderSlot(i.$slots, "default", {
      key: 0,
      edgeId: e.edgeId,
      edge: e.edge,
      config: e.config,
...
var rf = defineComponent({
  ...
  setup(e) {
    const t = Et(), { edgeStates: n, edgeGroupStates: o, summarizedEdgeStates: i } = Me(), r = computed(() => {
      const a = {}, l = {};
    ...
    return (a, l) => (openBlock(), createElementBlock("g", of, [
      e.enableEdgeLabel ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(unref(r).individual, (u, c) => (openBlock(), createElementBlock(Fragment, { key: c }, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(u.edges, (f, d) => (openBlock(), createBlock(tf, {
          key: d,
          "edge-id": d,
          edge: f,
          config: unref(t).label,
          state: unref(n)[d]
        }, {
          default: withCtx((v) => [
            renderSlot(a.$slots, "edge-label", normalizeProps(guardReactiveProps(v)))
          ]),
          _: 2
        }, 1032, ["edge-id", "edge", "config", "state"]))), 128))
      ], 64))), 128)) : createCommentVNode("", true),
      e.enableEdgesLabel ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(unref(r).summarized, (u, c) => (openBlock(), createBlock(nf, {
        key: c,
        edges: u.edges,
        config: unref(t).label,
        state: unref(n)[s(u)],
        "summarize-state": unref(i)[s(u)]
      }, {
        default: withCtx((f) => [
          renderSlot(a.$slots, "edges-label", normalizeProps(guardReactiveProps(f)))
        ]),
        _: 2
      }, 1032, ["edges", "config", "state", "summarize-state"]))), 128)) : createCommentVNode("", true)
    ]));
  }
});
var sf = defineComponent({
  ...
  setup(e) {
    return (t, n) => (openBlock(), createBlock(rf, {
...
var lf = { class: "v-ng-layer-nodes-selections" };
var cf = defineComponent({
  __name: "VFocusringLayer",
  setup(e) {
    const { nodeStates: t } = Me(), { selectedNodes: n } = vd(), o = Rn();
    return (i, r) => (openBlock(), createElementBlock("g", lf, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(n), (s) => (openBlock(), createBlock(af, {
        id: s,
        key: s,
        state: unref(t)[s],
        pos: unref(o).nodes[s]
...
var Zo = defineComponent({
  ...
  setup(e) {
    ...
    return (f, d) => (openBlock(), createElementBlock("g", {
      class: normalizeClass({ "v-ng-node": true, hover: e.state.hovered, selected: e.state.selected }),
      transform: `translate(${unref(n)} ${unref(o)})`,
      onPointerdown: d[0] || (d[0] = withModifiers((v) => unref(r)(e.id, v), ["stop"])),
      onPointerenterPassive: d[1] || (d[1] = (v) => unref(s)(e.id, v)),
      onPointerleavePassive: d[2] || (d[2] = (v) => unref(a)(e.id, v)),
      onClick: d[3] || (d[3] = withModifiers((v) => unref(l)(e.id, v), ["stop"])),
      onDblclick: d[4] || (d[4] = withModifiers((v) => unref(u)(e.id, v), ["stop"])),
      onContextmenu: d[5] || (d[5] = (v) => unref(c)(e.id, v))
    }, [
      renderSlot(f.$slots, "override-node", {
        nodeId: e.id,
        scale: unref(i),
...
var df = defineComponent({
  __name: "VNodesLayer",
  setup(e) {
    const t = useSlots(), n = computed(() => "override-node" in t), { nodeZOrderedList: o } = Me(), i = Ft(), r = Rn();
    return (s, a) => unref(n) ? (openBlock(), createBlock(TransitionGroup, {
      key: 0,
      ...
      default: withCtx(() => [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(o), (l) => (openBlock(), createBlock(Zo, {
          id: l.id,
          key: l.id,
          state: l,
          pos: unref(r).nodes[l.id]
        }, {
          "override-node": withCtx((u) => [
            renderSlot(s.$slots, "override-node", normalizeProps(guardReactiveProps(u)))
          ]),
          _: 2
...
var jo = defineComponent({
  ...
  setup(e) {
    ...
    }), v = computed(() => t.state.label.direction === N.CENTER ? 0 : t.state.label.margin * i.value), x = ref(0), P = ref(0), E = ref(0), p = ref(0), m = computed(() => {
      var B;
    ...
    const k = computed(() => (C) => n.label.handleNodeEvents ? {
      pointerdown: ($) => {
        $.stopPropagation(), r(C, $);
      },
      pointerenter: ($) => s(C, $),
    ...
    return (C, $) => (openBlock(), createElementBlock("g", mergeProps({
      class: unref(T),
      transform: `translate(${unref(f)} ${unref(d)})`
    }, toHandlers(unref(k)(e.id), true)), [
      renderSlot(C.$slots, "override-node-label", {
        ...
        createVNode(qt, {
          ...
          config: e.state.label,
          "text-anchor": unref(w),
          "dominant-baseline": unref(b),
          class: normalizeClass(unref(_)),
          transform: `translate(${unref(h)} ${unref(g)})`
...
var mf = defineComponent({
  ...
  setup(e) {
    const t = useSlots(), n = computed(() => "override-node-label" in t), { nodeZOrderedList: o } = Me(), i = Ft(), r = Rn(), s = computed(() => a(o.value));
    function a(l) {
      return l.filter((u) => {
        var c;
    ...
    return (l, u) => unref(n) ? (openBlock(), createBlock(TransitionGroup, {
      ...
      default: withCtx(() => [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(s), (c) => (openBlock(), createBlock(jo, {
          id: c.id,
          key: c.id,
          state: c,
          pos: unref(r).nodes[c.id]
        }, {
          "override-node-label": withCtx((f) => [
            renderSlot(l.$slots, "override-node-label", normalizeProps(guardReactiveProps(f)))
          ]),
          _: 2
        }, 1032, ["id", "state", "pos"]))), 128))
      ]),
...
function yf(e, t, n, o, i, r, s, a) {
  ...
  let d = false, v = false;
  {
    ...
    const w = a + (s === "edgeOfNode" ? m : 0), b = w <= 0 ? p.line.source : Bo(p, w, n, true);
    f.push(b), m = tt(t[p.target].shape) * i, a > 0 && te.distance(p.line.source, p.line.target) <= w + m && (d = true);
  }
  const x = l.length;
  for (let p = 1; p < x; p++) {
  ...
  }
  {
    ...
    const w = a + (s === "edgeOfNode" ? m : 0), b = w <= 0 ? p.line.target : Bo(p, w, n, false);
    if (m = tt(t[p.source].shape) * i, p.loop) {
      ...
      f.push(b);
    a > 0 && te.distance(p.line.source, p.line.target) <= w + m && (v = true);
  }
...
var Pf = ["d", "stroke", "stroke-width", "stroke-dasharray", "stroke-linecap", "stroke-linejoin"];
var Sf = defineComponent({
  __name: "VPath",
  props: {
    path: null
  ...
  setup(e) {
    ...
    }), c = computed(() => xt(u.value.dasharray, r.value)), f = computed(() => {
      const d = u.value.animate ? Vt(u.value.dasharray) * u.value.animationSpeed * r.value : false;
    ...
    return (d, v) => (openBlock(), createElementBlock("path", {
      ...
      "stroke-width": unref(u).width * unref(r),
...
var kf = defineComponent({
  ...
  setup(e) {
    ...
    return (u, c) => (openBlock(), createBlock(TransitionGroup, {
      ...
      default: withCtx(() => [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(t), (f) => (openBlock(), createBlock(Sf, {
          key: f.id,
          path: f,
          onPointerdown: (d) => unref(o)(f.id, d),
          onPointerenterPassive: (d) => unref(i)(f.id, d),
          onPointerleavePassive: (d) => unref(r)(f.id, d),
          onClick: withModifiers((d) => unref(s)(f.id, d), ["stop"]),
          onDblclick: withModifiers((d) => unref(a)(f.id, d), ["stop"]),
          onContextmenu: (d) => unref(l)(f.id, d)
...
var Mf = defineComponent({
  __name: "VPathsLayer",
  setup(e) {
    return (t, n) => (openBlock(), createBlock(kf));
  }
});
var Tf = { key: 0 };
var Of = defineComponent({
  ...
  setup(e, { expose: t, emit: n }) {
    const o = e, i = [
      ...
      "edge-label",
      "edges-label"
    ], r = useSlots(), s = toRef(o, "nodes"), a = toRef(o, "edges"), { objects: l, isInCompatibilityModeForPath: u } = dd(
      toRef(o, "paths")
    ), c = Gu();
    Object.entries(o.eventHandlers).forEach(([S, L]) => {
      c.on(S, L);
    });
    const f = _l(toRef(o, "configs")), d = computed(() => {
    ...
    }), v = computed(() => f.view.grid.visible), x = computed(() => {
      const S = d.value;
      return v.value || S.background.length > 0 || S.grid.length > 0;
    }), P = bd(f, r), E = ref(), p = ref(), m = ref(), w = ref(
      0
      /* INITIAL */
    ), b = computed(
      () => w.value !== 0
    ...
    k(() => {
      ...
      Object.assign(_, { width: D, height: V }), (et = m.value) == null || et.addEventListener("touchstart", Xn, { passive: false });
    }), T(() => {
      var S;
    ...
    const B = (S) => {
      var L;
      Object.keys(o.nodes).length > 0 ? ((L = g.value) == null || L.updateBBox(), nextTick(S)) : S();
    }, Y = () => {
      B(() => {
    ...
    watch(ie, (S) => c.emit("node:select", Array.from(S)));
    const Pe = cn(o, "selectedEdges", a, n);
    watch(Pe, (S) => c.emit("edge:select", Array.from(S)));
    const le = cn(o, "selectedPaths", l, n);
    watch(le, (S) => c.emit("path:select", Array.from(S))), hd(ie, Pe, le);
    const Qe = Ae(/* @__PURE__ */ new Set()), Je = Ae(/* @__PURE__ */ new Set()), Hn = Ae(/* @__PURE__ */ new Set()), _e = Ae({ nodes: {} });
    pd(_e), watch(
      () => o.layouts,
      () => Object.assign(_e, o.layouts),
      { deep: true, immediate: true }
    ), watch(_e, () => n("update:layouts", _e), { deep: true });
    const Kt = qc(), Yt = ref(false);
    c.on("node:dragstart", (S) => Yt.value = true), c.on("node:dragend", (S) => Yt.value = false), c.on("view:mode", (S) => {
      var L, D, V, re;
    ...
    const Wi = computed(() => f.view.panEnabled || f.view.zoomEnabled || f.node.draggable), { nodeStates: Fi, edgeStates: Ui, pathStates: Gi } = eu(
      sn(s, ie, Qe),
      sn(a, Pe, Je),
      sn(l, le, Hn),
      readonly(f),
      ...
      Kt,
      A
    ), Xi = computed(() => Qt(f.view)), { isBoxSelectionMode: qi, selectionBox: Vn, startBoxSelection: Ki, stopBoxSelection: Yi } = Fu(
      p,
      readonly(_e),
      readonly(h),
      Fi,
    ...
    const { transitionWhile: Qi, transitionOption: Fn } = ud(), Ji = computed(() => {
      const S = Fn.value;
      return S.enabled ? {
    ...
    k(() => {
      B(() => {
        ...
        f.view.layoutHandler.activate(Wn()), nextTick(() => {
          const L = f.view.autoPanAndZoomOnLoad;
          if (f.view.fit || L !== false) {
    ...
    return (S, L) => (openBlock(), createElementBlock("div", {
      ...
      (openBlock(), createElementBlock("svg", {
        ref_key: "svg",
        ref: p,
        class: normalizeClass(["v-ng-canvas", { show: unref(b), dragging: Yt.value, touches: unref(Wi), "box-selection-mode": unref(qi) }]),
        width: "100%",
        height: "100%"
      }, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(d).root, (D) => renderSlot(S.$slots, D, {
          key: D,
          scale: unref(A)
        })), 128)),
        Object.keys(unref(Kt).markers).length > 0 ? (openBlock(), createElementBlock("defs", Tf, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(Kt).markers, (D, V) => (openBlock(), createBlock(Od, {
            id: V,
            key: V,
            marker: D,
            scale: unref(A)
        ...
        unref(x) ? (openBlock(), createBlock(Ld, { key: 1 }, {
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(d).background, (D) => (openBlock(), createElementBlock("g", {
              key: D,
              class: "v-ng-layer"
            }, [
              renderSlot(S.$slots, D, { scale: unref(A) })
            ]))), 128)),
            unref(v) ? (openBlock(), createBlock(Ad, { key: 0 })) : createCommentVNode("", true),
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(d).grid, (D) => (openBlock(), createElementBlock("g", {
              key: D,
              class: "v-ng-layer"
            }, [
              renderSlot(S.$slots, D, { scale: unref(A) })
        ...
        createBaseVNode("g", {
          ref_key: "viewport",
          ref: m,
          class: normalizeClass(["v-ng-viewport", { "v-ng-transition": unref(Fn).enabled }]),
          style: normalizeStyle(unref(Ji))
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(d).base, (D) => (openBlock(), createElementBlock("g", {
            key: D,
            class: "v-ng-layer"
          }, [
            renderSlot(S.$slots, D, { scale: unref(A) })
          ]))), 128)),
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(P), (D) => (openBlock(), createElementBlock(Fragment, { key: D }, [
            D === "edges" ? (openBlock(), createBlock(ef, { key: 0 }, {
              "edge-overlay": withCtx((V) => [
                renderSlot(S.$slots, "edge-overlay", normalizeProps(guardReactiveProps(V)))
              ]),
              _: 3
            })) : D === "edge-labels" ? (openBlock(), createBlock(sf, {
              key: 1,
              "enable-edge-label": "edge-label" in unref(r),
              "enable-edges-label": "edges-label" in unref(r)
            }, {
              "edge-label": withCtx((V) => [
                renderSlot(S.$slots, "edge-label", normalizeProps(guardReactiveProps(V)))
              ]),
              "edges-label": withCtx((V) => [
                renderSlot(S.$slots, "edges-label", normalizeProps(guardReactiveProps(V)))
              ]),
              _: 3
            }, 8, ["enable-edge-label", "enable-edges-label"])) : D === "focusring" ? (openBlock(), createBlock(cf, { key: 2 })) : D === "nodes" ? (openBlock(), createBlock(df, { key: 3 }, {
              "override-node": withCtx((V) => [
                renderSlot(S.$slots, "override-node", normalizeProps(guardReactiveProps(V)))
              ]),
              _: 3
            })) : D === "node-labels" ? (openBlock(), createBlock(mf, { key: 4 }, {
              "override-node-label": withCtx((V) => [
                renderSlot(S.$slots, "override-node-label", normalizeProps(guardReactiveProps(V)))
              ]),
              _: 3
            })) : D === "paths" ? (openBlock(), createBlock(Mf, { key: 5 })) : createCommentVNode("", true),
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(d)[D], (V) => (openBlock(), createElementBlock("g", {
              key: V,
              class: "v-ng-layer"
            }, [
              renderSlot(S.$slots, V, { scale: unref(A) })
            ]))), 128))
          ], 64))), 128))
        ], 6),
        unref(Vn) ? (openBlock(), createBlock(wd, {
          key: 2,
          box: unref(Vn),
          config: unref(f).view.selection.box
...
var Cf = defineComponent({
  ...
  setup(e) {
    const t = e, n = ref(0), o = ref(0), i = ref("middle"), r = ref("central"), s = ref(0);
    watchEffect(() => {
    ...
    const a = computed(() => r.value === "central" && !t.config.background ? st(se({}, t.config), {
      background: {
        visible: true,
        color: "#ffffff",
        padding: {
    ...
    return (l, u) => (openBlock(), createBlock(qt, {
